...
// Device ID
String deviceId = "37cb3a70-2452-4acd-8957-14bc2f89b1dc";

// Pin for smoke sensor (GPIO 13)
const int smokePin = 13;
// Pin for buzzer (GPIO 12)
...
void setup() {
  ...
  wifiManager.autoConnect("ESP32_Config_AP");  // Changed name to ESP32
